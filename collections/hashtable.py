...
class HashTable(MutableMapping):
    ...
    def __getitem__(self, key):
        """
        Private method that returns either an indexed item.
    ...
    def __setitem__(self, key, value):
        ...
        if isinstance(key, int):
            ...
            raise IndexError(f'__setitem__() expects either an int or str ({type(key).__name__} given)!')
    ...
    def __delitem__(self, index):
        ...
        if isinstance(key, int):
            ...
            raise IndexError(f'__delitem__() expects either an int or str ({type(key).__name__} given)!')
    ...
    def get(self, key, default=None):
        ...
        if isinstance(key, int):
            ...
            raise IndexError(f'get() expects either an int or str ({type(key).__name__} given)!')
